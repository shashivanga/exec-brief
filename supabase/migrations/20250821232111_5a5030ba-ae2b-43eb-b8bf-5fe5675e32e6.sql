...
CREATE TABLE public.items (
    ...
    raw JSONB,
    created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
    UNIQUE (org_id, COALESCE(company_id, '00000000-0000-0000-0000-000000000000'::uuid), COALESCE(topic_id, '00000000-0000-0000-0000-000000000000'::uuid), source_kind, source_id)
);
