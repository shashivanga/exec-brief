-- ============================================================================
-- COMPREHENSIVE DATABASE SCHEMA IMPLEMENTATION (FIXED)
...
-- Create unique index for company_catalog deduplication
CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS idx_company_catalog_unique 
...
-- Create unique index for ingested_items deduplication
CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS idx_ingested_items_unique
